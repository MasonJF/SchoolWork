...
public class AirVehicle extends Vehicle {
    ...
    public void nudge() {
        ...
        propSpeed = rand.nextDouble() * 100;
        steeringDirection = Vehicle.getRandomDirection();
        tiltDirection = getRandomDirection();
    }

    @Override
    public void print() {
                System.out.println(speed + " KM " + propSpeed + "=PropSpeed "   +  position[0] + "=x" + " " + position[1] +
                        "=y " + position[2] + "=z" +  " Direction=" + direction + " VerticalDirection=" + verticalDirection +  " " +
                        tiltDirection + "=TiltDirection " + " Steering value=" + steeringDirection);
                System.out.println(" ");
    }
