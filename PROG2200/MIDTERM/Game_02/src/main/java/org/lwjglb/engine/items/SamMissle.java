...
//    private Vector3f position = new Vector3f(0, 0,0);
    ...
    public SamMissle(Vector3f position, double speed, int damage, int size, double direction, Mesh[] mesh) {
...
//        Vector3f position = new Vector3f(rand.nextInt(10), rand.nextInt(10), 0);
        ...
        return new SamMissle(position, 100, 100, 1, direction, getObjmesh());
    }
