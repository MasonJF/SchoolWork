...
//    int[] position;
    ...
    public Vehicle(Vector3f position, double speed, double direction, Enum steeringDirection, double health) {
        super();
...
//                return new FireBullet(position, speedFaster, bulletDamage, bulletSize, direction, getObjmesh());
                ...
                return new SamMissle(position, speedFaster, 100, 1, direction);
            case 1:
