...
import org.lwjglb.engine.items.RussItem;
...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        RussItem house = new RussItem(houseMesh);
        house.setVelocity(0.00010f, 0.0000010f, 0.00020f);
        ...
        Mesh[] russMesh = StaticMeshesLoader.load("src/main/resources/models/russ/ball.obj", "src/main/resources/models/russ");
...
//            Mesh[] addMesh = StaticMeshesLoader.load("src/main/resources/models/russ/russ9.obj", "src/main/resources/models/russ");
            ...
            shape.setScale(0.150f);  //house needs to be shrunk
